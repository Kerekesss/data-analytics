    ...
    <div className="text-white" id="subscribe">
      <div className="max-w-[1240px] mx-auto flex max-lg:flex-col max-lg:items-center max-lg:text-center py-20 px-6">
        ...
        <div className="flex flex-col pt-2 ">
          <div className="flex max-lg:flex-col gap-4 max-lg:items-center max-lg:px-4">
            <input
              type="text"
              placeholder="Enter your Email"
              className="p-2 px-3 rounded-lg w-[250px] max-lg:w-[580px] max-md:w-[470px] max-sm:w-[90%]"
            />
            <button className="bg-green1 text-black w-[130px] rounded-md font-medium py-3 max-lg:w-[580px] max-md:w-[470px] max-sm:w-[90%]">
              Notify me
            </button>
          </div>
